...
const benefits = [
  ...
  "Reduce patient no-shows by 40% with automated reminders",
  "Instant access to complete patient medical histories",
  "HIPAA-compliant secure data storage and transmission",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Join thousands of healthcare providers who have transformed their practice 
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="p-8 rounded-2xl bg-gradient-to-br from-accent/10 to-primary-glow/10 border border-accent/20">
                <div className="text-5xl font-bold text-primary-glow mb-2">24/7</div>
